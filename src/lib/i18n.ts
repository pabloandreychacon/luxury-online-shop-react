  ...
  en: {
    translation: {
      ...
      checkout: {
        ...
        days: 'days',
        discount: 'Discount',
        discountQualify: 'Add {n} more to get {p}% off',
        youSave: 'You save',
        savings: 'Savings',
      ...
      admin: {
        ...
        analyticsFilterDate: 'Filter by Date',
        analyticsFilterType: 'Filter by Type',
        analyticsTypeAll: 'All',
        deviceType: 'Device',
        os: 'OS',
        browser: 'Browser',
        lang: 'Lang',
        ...
        discountMinQuantity: 'Min Qty for Discount',
        actions: 'Actions',
        cancel: 'Cancel',
  ...
  zh: {
    translation: {
      ...
      checkout: {
        ...
        days: '天',
        discount: '折扣',
        discountQualify: '再买 {n} 件即可享受 {p}% 折扣',
        youSave: '您节省',
        savings: '节省金额',
        orderCompleted: '订单完成！',
      ...
      admin: {
        ...
        sessions: '会话',
        interactions: '交互',
        analyticsFilterDate: '按日期筛选',
        analyticsFilterType: '按类型筛选',
        analyticsTypeAll: '全部',
        deviceType: '设备',
        os: '系统',
        browser: '浏览器',
  ...
  es: {
    translation: {
      ...
      checkout: {
        ...
        days: 'días',
        discount: 'Descuento',
        discountQualify: 'Agrega {n} más para obtener {p}% de descuento',
        youSave: 'Ahorras',
        savings: 'Ahorro',
      ...
      admin: {
        ...
        analyticsFilterDate: 'Filtrar por Fecha',
        analyticsFilterType: 'Filtrar por Tipo',
        analyticsTypeAll: 'Todas',
        ...
        discountMinQuantity: 'Cant. Mín. para Descuento',
        actions: 'Acciones',
        cancel: 'Cancelar',
